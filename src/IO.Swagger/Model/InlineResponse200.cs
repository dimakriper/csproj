...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse200 :  IEquatable<InlineResponse200>, IValidatableObject
    {
        ...
        public InlineResponse200(List<FeedCompany> companies = default(List<FeedCompany>))
        {
            // to ensure "companies" is required (not null)
            if (companies == null)
            {
                throw new InvalidDataException("companies is a required property for InlineResponse200 and cannot be null");
            }
            else
            {
        ...
        public List<FeedCompany> Companies { get; set; }
