...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse2003 :  IEquatable<InlineResponse2003>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="reviews">reviews (required).</param>
        public InlineResponse2003(List<Review> reviews = default(List<Review>))
        {
            // to ensure "reviews" is required (not null)
            if (reviews == null)
            {
                throw new InvalidDataException("reviews is a required property for InlineResponse2003 and cannot be null");
            }
            else
            {
