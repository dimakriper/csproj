...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse2004 :  IEquatable<InlineResponse2004>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="availableDates">availableDates (required).</param>
        public InlineResponse2004(List<AvailableDate> availableDates = default(List<AvailableDate>))
        {
            // to ensure "availableDates" is required (not null)
            if (availableDates == null)
            {
                throw new InvalidDataException("availableDates is a required property for InlineResponse2004 and cannot be null");
            }
            else
            {
