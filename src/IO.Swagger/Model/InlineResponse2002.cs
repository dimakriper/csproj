...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse2002 :  IEquatable<InlineResponse2002>, IValidatableObject
    {
        ...
        public InlineResponse2002(List<Resource> resources = default(List<Resource>))
        {
            // to ensure "resources" is required (not null)
            if (resources == null)
            {
                throw new InvalidDataException("resources is a required property for InlineResponse2002 and cannot be null");
            }
            else
            {
