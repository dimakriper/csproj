...
namespace IO.Swagger.Model
{
        ...
        public partial class UserInfo :  IEquatable<UserInfo>, IValidatableObject
    {
        ...
        public UserInfo(string name = default(string), string phone = default(string), string email = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for UserInfo and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (phone == null)
            {
                throw new InvalidDataException("phone is a required property for UserInfo and cannot be null");
            }
            else
            {
                this.Phone = phone;
